...
def init_css():
    ...
    TTKStyle('H3.TButton', font=('',18), background='gray86')
    TTKStyle('H4.TButton', font=('',16), background='gray86')
    TTKStyle('H5.TButton', font=('',13), background='gray86')
    TTKStyle('H6.TButton', font=('',10), background='gray86')
