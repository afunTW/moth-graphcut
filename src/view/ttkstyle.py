...
def init_css():
    ...
    TTKStyle('H1.TLabelframe', background='white')
    TTKStyle('H1.TLabelframe.Label', font=('', 32, 'bold'), background='white')
    TTKStyle('H2.TLabelframe', background='white')
    TTKStyle('H2.TLabelframe.Label', font=('', 24, 'bold'), background='white')
    TTKStyle('H3.TLabelframe', background='gray82')
    TTKStyle('H3.TLabelframe.Label', font=('', 18), background='gray82')
    TTKStyle('H4.TLabelframe', background='gray82')
    TTKStyle('H4.TLabelframe.Label', font=('', 16), background='gray82')
    TTKStyle('H5.TLabelframe', background='gray82')
    TTKStyle('H5.TLabelframe.Label', font=('', 13, 'bold'), background='gray82')
    TTKStyle('H6.TLabelframe', background='gray82')
    TTKStyle('H6.TLabelframe.Label', font=('', 10), background='gray82')
    ...
    TTKStyle('H1.TRadiobutton', font=('', 32, 'bold'), background='gray82')
    TTKStyle('H2.TRadiobutton', font=('', 24, 'bold'), background='gray82')
    TTKStyle('H3.TRadiobutton', font=('', 18), background='gray82')
    TTKStyle('H4.TRadiobutton', font=('', 16), background='gray82')
    TTKStyle('H5.TRadiobutton', font=('', 13), background='gray82')
    TTKStyle('H6.TRadiobutton', font=('', 10), background='gray82')
    TTKStyle('Gray.Horizontal.TScale', padding=20, background='gray82')
